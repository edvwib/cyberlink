        ...
        <ul class="navbar-nav mr-auto">
            ...
            <?php if ($_SESSION['authenticated']): ?>
                <li class="nav-item <?php echo ($query['page']==='user' || $query['page']==='profile')?('active'):('') ?> dropdown">
                    ...
                    You (<?php echo $_SESSION['user']['username'] ?>)
                    </a>
                    <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item <?php echo ($query['page']==='user')?('navbar-white'):('navbar-gray') ?>" href="?page=user&user=<?php echo $_SESSION['user']['username'] ?>">Your posts</a>
